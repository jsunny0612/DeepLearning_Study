...
log_dir = '/media/user/SH/Chung_Ang/Week1_Image_Classification/results/Resnet/cifar10'
...
# Transformations with Data Augmnetaion for the CIFAR-10 dataset
...
for epoch in range(epochs):
    print(f"\n======= Data_Aug_Resnet_CIFAR10_Epoch {epoch + 1}/{epochs} =======")
    print(f'Epoch {epoch + 1}:')

    train_loss, train_acc = train(model, train_loader, criterion, optimizer, epoch)
    test_loss, test_acc = test(model, test_loader, criterion, epoch)

    writer.add_scalars('Data_Aug_Resnet_CIFAR10_Loss', {'Train Loss': train_loss, 'Test Loss': test_loss}, epoch + 1)
    writer.add_scalars('Data_Aug_Resnet_CIFAR10_Accuracy', {'Train Accuracy': train_acc, 'Test Accuracy': test_acc}, epoch + 1)
