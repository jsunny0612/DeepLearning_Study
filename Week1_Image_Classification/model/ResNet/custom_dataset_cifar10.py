...
for epoch in range(epochs):
    ...
    writer.add_scalars('Resnet_CIFAR10_Loss', {'Train Loss': train_loss, 'Test Loss': test_loss}, epoch + 1)
    writer.add_scalars('Resnet_CIFAR10_Accuracy', {'Train Accuracy': train_acc, 'Test Accuracy': test_acc}, epoch + 1)
