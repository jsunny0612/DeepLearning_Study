...
log_dir = '/media/user/SH/Chung_Ang/Week1_Image_Classification/results/Resnet/mnist'
...
train_dataset = CustomMNISTDataset(root='/media/user/SH/Chung_Ang/Week1_Image_Classification/data', train=True, transform=transform)
test_dataset = CustomMNISTDataset(root='/media/user/SH/Chung_Ang/Week1_Image_Classification/data', train=False, transform=transform)
