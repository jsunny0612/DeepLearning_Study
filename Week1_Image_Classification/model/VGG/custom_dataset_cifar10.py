...
for epoch in range(epochs):
    print(f"\n======= VGG_CIFAR10_Epoch {epoch + 1}/{epochs} =======")
    print(f'Epoch {epoch + 1}:')

    train_loss, train_acc = train(model, train_loader, criterion, optimizer)
    test_loss, test_acc = test(model, test_loader, criterion)

    writer.add_scalars('VGG_CIFAR10_Loss', {'Train Loss': train_loss, 'Test Loss': test_loss}, epoch + 1)
    writer.add_scalars('VGG_CIFAR10_Accuracy', {'Train Accuracy': train_acc, 'Test Accuracy': test_acc}, epoch + 1)
