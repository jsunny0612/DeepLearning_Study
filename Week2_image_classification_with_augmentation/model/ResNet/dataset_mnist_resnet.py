...
train_dataset = CustomMNISTDataset(root='/media/user/HDD2/sh/Chung_Ang/Week1_Image_Classification/data/MNIST/raw', train=True, transform=transform)
test_dataset = CustomMNISTDataset(root='/media/user/HDD2/sh/Chung_Ang/Week1_Image_Classification/data/MNIST/raw', train=False, transform=transform)
...
for epoch in range(epochs):
    ...
    writer.add_scalars('Resnet_MNIST_Loss', {'Train Loss': train_loss, 'Validation Loss': val_loss, 'Test Loss': test_loss}, epoch + 1)
    writer.add_scalars('Resnet_MNIST_Accuracy', {'Train Accuracy': train_acc, 'Validation Accuracy': val_acc, 'Test Accuracy': test_acc}, epoch + 1)
