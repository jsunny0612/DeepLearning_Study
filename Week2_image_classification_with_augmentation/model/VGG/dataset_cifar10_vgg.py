...
full_train_dataset = CustomCIFAR10Dataset(root='/media/user/SH/Chung_Ang/Week2_image_classification_with_augmentation/data/cifar10/', train=True, transform=transform)
test_dataset = CustomCIFAR10Dataset(root='/media/user/SH/Chung_Ang/Week2_image_classification_with_augmentation/data/cifar10/', train=False, transform=transform)
...
for epoch in range(epochs):
    ...
    writer.add_scalars('VGG_CIFAR10_Loss', {'Train Loss': train_loss, 'Validation Loss': val_loss, 'Test Loss': test_loss}, epoch + 1)
    writer.add_scalars('VGG_CIFAR10_Accuracy', {'Train Accuracy': train_acc, 'Validation Accuracy': val_acc, 'Test Accuracy': test_acc}, epoch + 1)
