...
# from data_utils.imdb_loader import IMDBDataset
...
def main():
    ...
    for epoch in range(epochs):
        ...
        writer.add_scalars(f'{args.model}_Loss', {'Train': train_loss, 'Validation': val_loss, 'Test': test_loss},epoch + 1)
        writer.add_scalars(f'{args.model}_Accuracy', {'Train': train_acc, 'Validation': val_acc, 'Test': test_acc},epoch + 1)
